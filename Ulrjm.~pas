...
uses
  ...
  StdCtrls, RzEdit, Mask, RzLabel;

type
  TFlrjm = class(TFBaseEdit)
    RzLabel1: TRzLabel;
    RzLabel2: TRzLabel;
    RzLabel3: TRzLabel;
    RzLabel4: TRzLabel;
...
procedure TFlrjm.RzBitBtn2Click(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TFlrjm.RzBitBtn1Click(Sender: TObject);
begin
  inherited;
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('select * from mflly where id=1');
    Open;
    Append;
...
procedure TFlrjm.FormShow(Sender: TObject);
begin
  inherited;
